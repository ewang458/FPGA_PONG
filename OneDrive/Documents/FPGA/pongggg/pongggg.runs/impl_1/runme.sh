...
HD_PWD='C:/Users/aarus/OneDrive/Documents/FPGA/pongggg/pongggg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_f.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_f.tcl -notrace
