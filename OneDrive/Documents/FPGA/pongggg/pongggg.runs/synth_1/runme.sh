...
HD_PWD='C:/Users/aarus/OneDrive/Documents/FPGA/pongggg/pongggg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_f.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_f.tcl
