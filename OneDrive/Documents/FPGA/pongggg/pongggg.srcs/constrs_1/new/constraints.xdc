...
set_property PULLUP TRUE [get_ports {up1}];
set_property PULLUP TRUE [get_ports {down1}];
set_property PULLUP TRUE [get_ports {up2}];
set_property PULLUP TRUE [get_ports {down2}];
